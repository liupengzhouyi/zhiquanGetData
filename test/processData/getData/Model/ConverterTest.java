...
public class ConverterTest {
    ...
    public void setUp() throws Exception {
        OrdCompanyInformation ordCompanyInformation = new OrdCompanyInformation(
                "中天建设集团有限公司内蒙古公司",
                "联 系 人：张部长",
                "联系电话：04715255440",
                "所属行业：石油/石化/化工",
        ...
        this.converter = new Converter(ordCompanyInformation);
    }
    ...
    @Test
    public void getNewCompanyInformation() {
        System.out.println(this.getConverter().getNewCompanyInformation().toString());
    }
}