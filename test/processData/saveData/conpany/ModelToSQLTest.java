...
public class ModelToSQLTest {

    private ModelToSQL modelToSQL;

    private NewCompanyInformation newCompanyInformation;

    private OrdCompanyInformation ordCompanyInformation;

    public ModelToSQL getModelToSQL() {
        return modelToSQL;
    }

    public void setModelToSQL(ModelToSQL modelToSQL) {
        this.modelToSQL = modelToSQL;
    }
    ...
    public processData.operrationData.model.OrdCompanyInformation getOrdCompanyInformation() {
    ...
    public void setUp() throws Exception {
        ...
        this.newCompanyInformation = new Converter(this.getOrdCompanyInformation()).getNewCompanyInformation();

        this.modelToSQL = new ModelToSQL(this.getNewCompanyInformation());
    }
    ...
    @Test
    public void getSql() {
        System.out.print(this.getModelToSQL().getSql());
    }
